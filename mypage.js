(function () {
  ...
  const BADGE_DEFS = [
    ...
    { id: "verified_1",    emoji: "🧾",  label: "영수증 인증",   desc: "인증 리뷰 1개",       theme: "green",  check: (d) => d.verifiedCount >= 1  },
    { id: "verified_3",    emoji: "🧾",  label: "인증 단골",     desc: "인증 리뷰 3개",       theme: "green",  check: (d) => d.verifiedCount >= 3  },
    { id: "verified_5",    emoji: "🏅",  label: "인증 마스터",   desc: "인증 리뷰 5개",       theme: "gold",   check: (d) => d.verifiedCount >= 5  },
    { id: "verified_10",   emoji: "👑",  label: "영수증 챔피언", desc: "인증 리뷰 10개",      theme: "gold",   check: (d) => d.verifiedCount >= 10 },
